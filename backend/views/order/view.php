...
<div class="article-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'money',
            'rdt',
            ['label'=>'打款人银行','value'=>$model->uid],
            ['label'=>'打款人姓名','value'=>$model->uid],
            ['label'=>'打款人账户号码','value'=>$model->uid],
            ['label'=>'打款人QQ','value'=>$model->uid],
            ['label'=>'打款人微信号','value'=>$model->uid],
            ['label'=>'打款人微信钱包','value'=>$model->uid],
            ['label'=>'打款人财付通','value'=>$model->uid],
            ['label'=>'打款人电话','value'=>$model->uid],
            ['label'=>'打款金额','value'=>$model->uid],
            ['label'=>'查看凭证','value'=>Html::a("查看凭证", $model->img)],
        ],
    ]) ?>
